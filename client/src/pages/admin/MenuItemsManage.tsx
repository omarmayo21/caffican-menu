...
export default function MenuItemsManage() {
  ...
  const handleCreate = async (e: React.FormEvent) => {
    ...
    setFormData({ name: "", price: "", description: "", image: "", categoryId: "", sectionId: "" });
    setIsCreating(false);
  };
  ...
  return (
    <AdminLayout>
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-3xl font-bold font-display text-foreground">Menu Items</h1>
      ...
      {isCreating && (
        <form onSubmit={handleCreate} className="bg-card border border-border rounded-2xl p-6 mb-8 space-y-4">
